Shader "Shader Graphs/HologramShader" {
	Properties {
		[HDR] _FresnelColor ("FresnelColor", Vector) = (1,0,0,0)
		[HDR] _MainColor ("MainColor", Vector) = (0,0,0,0)
		[NoScaleOffset] _HologramScanlines ("HologramScanlines", 2D) = "white" {}
		_ScrollSpeed ("ScrollSpeed", Float) = 0
		_HologramTiling ("HologramTiling", Vector) = (1,1,0,0)
