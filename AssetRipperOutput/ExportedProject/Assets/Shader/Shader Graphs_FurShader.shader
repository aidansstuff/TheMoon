Shader "Shader Graphs/FurShader" {
	Properties {
		[NoScaleOffset] _Diffuse ("Diffuse", 2D) = "white" {}
		_ColorVariation ("ColorVariation", Float) = 0
		_Fur_Size ("Fur_Size", Float) = 0
		_Fur_Density ("Fur_Density", Float) = 0
		_Fur_Movement ("Fur_Movement", Float) = 0
		_Fur_Sharpness ("Fur_Sharpness", Float) = 0
		[NoScaleOffset] _Fur_Mask ("Fur_Mask", 2D) = "white" {}
		_Fur_Direction ("Fur_Direction", Float) = 0
		_Fur_Factor ("Fur_Factor", Float) = 0
		[NoScaleOffset] _NormalMapTex ("NormalMapTex", 2D) = "white" {}
		...
		[Enum(None, 0, Phong, 1)] [HideInInspector] _TessellationMode ("Float", Float) = 0
		...
		[ToggleUI] [HideInInspector] _ReceivesSSR ("Boolean", Float) = 0
