namespace UnityEngine.Rendering.HighDefinition
{
	internal static class HDShaderIDs
	{
		...
		public static readonly int[] _GBufferTexture = new int[8]
		{
		...
		public static readonly int[] _GBufferTextureRW = new int[8]
		{
		...
		public static readonly int[] _DBufferTexture = new int[4]
		{
