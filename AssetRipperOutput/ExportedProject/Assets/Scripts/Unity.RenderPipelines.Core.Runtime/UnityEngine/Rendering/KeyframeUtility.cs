...
namespace UnityEngine.Rendering
{
	public class KeyframeUtility
	{
		...
		private static Keyframe LerpSingleKeyframe(Keyframe lhs, Keyframe rhs, float t)
		{
			...
			result.time = Mathf.Lerp(lhs.time, rhs.time, t);
			result.value = Mathf.Lerp(lhs.value, rhs.value, t);
			result.inTangent = Mathf.Lerp(lhs.inTangent, rhs.inTangent, t);
			result.outTangent = Mathf.Lerp(lhs.outTangent, rhs.outTangent, t);
			result.inWeight = Mathf.Lerp(lhs.inWeight, rhs.inWeight, t);
			result.outWeight = Mathf.Lerp(lhs.outWeight, rhs.outWeight, t);
			result.weightedMode = lhs.weightedMode;
			return result;
		}
