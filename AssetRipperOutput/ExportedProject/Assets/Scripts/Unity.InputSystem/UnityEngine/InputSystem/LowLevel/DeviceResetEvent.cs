...
namespace UnityEngine.InputSystem.LowLevel
{
	...
	public struct DeviceResetEvent : IInputEventTypeInfo
	{
		...
		{
			DeviceResetEvent deviceResetEvent = default(DeviceResetEvent);
			deviceResetEvent.baseEvent = new InputEvent(1146245972, 20, deviceId, time);
			DeviceResetEvent result = deviceResetEvent;
