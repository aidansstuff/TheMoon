...
namespace Unity.Netcode
{
	internal struct BufferSerializerReader : IReaderWriter
	{
		...
		{
			m_Reader.ReadValueSafe(out value, default(FastBufferWriter.ForPrimitives));
		}
		...
		{
			m_Reader.ReadValueSafe(out value, default(FastBufferWriter.ForEnums));
		}
		...
		{
			m_Reader.ReadValueSafe(out value, default(FastBufferWriter.ForStructs));
		}
		...
		{
			m_Reader.ReadValueSafe(out value, allocator, default(FastBufferWriter.ForGeneric));
		}
		...
		public void SerializeValue<T>(ref T[] value, FastBufferWriter.ForNetworkSerializable unused = default(FastBufferWriter.ForNetworkSerializable)) where T : INetworkSerializable, new()
		{
			m_Reader.ReadValue(out value, default(FastBufferWriter.ForNetworkSerializable));
		}
		...
		{
			m_Reader.ReadValueSafe(out value, default(FastBufferWriter.ForFixedStrings));
		}
		...
		{
			m_Reader.ReadValue(out value, default(FastBufferWriter.ForPrimitives));
		}
		...
		{
			m_Reader.ReadValue(out value, default(FastBufferWriter.ForEnums));
		}
		...
		{
			m_Reader.ReadValue(out value, default(FastBufferWriter.ForStructs));
		}
		...
		{
			m_Reader.ReadValue(out value, allocator, default(FastBufferWriter.ForGeneric));
		}
		...
		{
			m_Reader.ReadValue<T>(out value, default(FastBufferWriter.ForFixedStrings));
		}
