...
public class RadMechAI : EnemyAI, IVisibleThreat
{
	...
	public void ChangeBroadcastClipClientRpc(int clipIndex)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Client && (networkManager.IsServer || networkManager.IsHost))
			{
				...
				FastBufferWriter bufferWriter = __beginSendClientRpc(3910336672u, clientRpcParams, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, clipIndex);
				__endSendClientRpc(ref bufferWriter, 3910336672u, clientRpcParams, RpcDelivery.Reliable);
			}
	...
	public void ChangeFlightLandingPositionClientRpc(Vector3 newLandingPosition)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(492577947u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in newLandingPosition);
				__endSendClientRpc(ref bufferWriter, 492577947u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
				landingPosition = newLandingPosition;
	...
	public void EndFlightClientRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(2143274786u, clientRpcParams, RpcDelivery.Reliable);
				__endSendClientRpc(ref bufferWriter, 2143274786u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
				finishingFlight = true;
	...
	public void SetChargingForwardClientRpc(bool charging)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(220033949u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in charging, default(FastBufferWriter.ForPrimitives));
				__endSendClientRpc(ref bufferWriter, 220033949u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
	...
	public void EnterFlightClientRpc(Vector3 newLandingPosition)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(773938193u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in newLandingPosition);
				__endSendClientRpc(ref bufferWriter, 773938193u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
	...
	public void SetMechAlertedClientRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(930524462u, clientRpcParams, RpcDelivery.Reliable);
				__endSendClientRpc(ref bufferWriter, 930524462u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
				isAlerted = true;
	...
	public void SetAimingClientRpc(bool aiming)
	{
		...
		{
			ClientRpcParams clientRpcParams = default(ClientRpcParams);
			FastBufferWriter bufferWriter = __beginSendClientRpc(742303271u, clientRpcParams, RpcDelivery.Reliable);
			bufferWriter.WriteValueSafe(in aiming, default(FastBufferWriter.ForPrimitives));
			__endSendClientRpc(ref bufferWriter, 742303271u, clientRpcParams, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
		{
			aimingGun = aiming;
	...
	public void ShootGunClientRpc(Vector3 startPos, Vector3 startRot)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(355979910u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in startPos);
				bufferWriter.WriteValueSafe(in startRot);
				__endSendClientRpc(ref bufferWriter, 355979910u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
	...
	public void SetExplosionServerRpc(Vector3 explosionPosition, Vector3 forwardRotation)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			if (__rpc_exec_stage != __RpcExecStage.Server && (networkManager.IsClient || networkManager.IsHost))
			{
				...
				FastBufferWriter bufferWriter = __beginSendServerRpc(4127084456u, serverRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in explosionPosition);
				bufferWriter.WriteValueSafe(in forwardRotation);
				__endSendServerRpc(ref bufferWriter, 4127084456u, serverRpcParams, RpcDelivery.Reliable);
			}
	...
	public void SetExplosionClientRpc(Vector3 explosionPosition, Vector3 forwardRotation, bool calledByClient = false)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(2435131453u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in explosionPosition);
				bufferWriter.WriteValueSafe(in forwardRotation);
				bufferWriter.WriteValueSafe(in calledByClient, default(FastBufferWriter.ForPrimitives));
				__endSendClientRpc(ref bufferWriter, 2435131453u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && (!base.IsServer || calledByClient))
			{
				SetExplosion(explosionPosition, forwardRotation);
			}
		}
	...
	{
		if (targetedThreat.threatScript == null || focusedThreatTransform == null)
		{
	...
	public void SetHasLineOfSightClientRpc(bool hasLineOfSight)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(3895603057u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in hasLineOfSight, default(FastBufferWriter.ForPrimitives));
				__endSendClientRpc(ref bufferWriter, 3895603057u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
	...
	public void SetLostCreatureInChaseClientRpc(bool lostInChase)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(1452186173u, clientRpcParams, RpcDelivery.Reliable);
				bufferWriter.WriteValueSafe(in lostInChase, default(FastBufferWriter.ForPrimitives));
				__endSendClientRpc(ref bufferWriter, 1452186173u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
	...
	public override void Update()
	{
		...
		case 1:
			...
			if (hasLOS && focusedThreatTransform != null)
			{
	...
	public void GrabPlayerServerRpc(int playerId)
	{
		...
		{
			ServerRpcParams serverRpcParams = default(ServerRpcParams);
			FastBufferWriter bufferWriter = __beginSendServerRpc(3707286996u, serverRpcParams, RpcDelivery.Reliable);
			BytePacker.WriteValueBitPacked(bufferWriter, playerId);
			__endSendServerRpc(ref bufferWriter, 3707286996u, serverRpcParams, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage == __RpcExecStage.Server && (networkManager.IsServer || networkManager.IsHost) && attemptingGrab && !inTorchPlayerAnimation && !inSpecialAnimationWithPlayer && !inSpecialAnimation && !StartOfRound.Instance.allPlayerScripts[playerId].isPlayerDead && !StartOfRound.Instance.allPlayerScripts[playerId].inAnimationWithEnemy)
		{
	...
	public void GrabPlayerClientRpc(int playerId, Vector3 enemyPosition, int enemyYRot)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(2279077176u, clientRpcParams, RpcDelivery.Reliable);
				BytePacker.WriteValueBitPacked(bufferWriter, playerId);
				bufferWriter.WriteValueSafe(in enemyPosition);
				BytePacker.WriteValueBitPacked(bufferWriter, enemyYRot);
				__endSendClientRpc(ref bufferWriter, 2279077176u, clientRpcParams, RpcDelivery.Reliable);
			}
	...
	public void StartGrabAttemptClientRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(1073473023u, clientRpcParams, RpcDelivery.Reliable);
				__endSendClientRpc(ref bufferWriter, 1073473023u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
				creatureAnimator.SetBool("AttemptingGrab", value: true);
	...
	public void FinishAttemptingGrabClientRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(3684373613u, clientRpcParams, RpcDelivery.Reliable);
				__endSendClientRpc(ref bufferWriter, 3684373613u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && !base.IsServer)
			{
				attemptingGrab = false;
	...
	public void SetTargetToThreatClientRpc(NetworkObjectReference netObject, Vector3 lastSeenPos)
	{
		...
		{
			ClientRpcParams clientRpcParams = default(ClientRpcParams);
			FastBufferWriter bufferWriter = __beginSendClientRpc(1292035047u, clientRpcParams, RpcDelivery.Reliable);
			bufferWriter.WriteValueSafe(in netObject, default(FastBufferWriter.ForNetworkSerializable));
			bufferWriter.WriteValueSafe(in lastSeenPos);
			__endSendClientRpc(ref bufferWriter, 1292035047u, clientRpcParams, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Client || (!networkManager.IsClient && !networkManager.IsHost) || base.IsServer)
		{
			return;
	...
	public void TakeLeftStepForwardClientRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(4188407647u, clientRpcParams, RpcDelivery.Reliable);
				__endSendClientRpc(ref bufferWriter, 4188407647u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost))
			{
	...
	public void TakeRightStepForwardClientRpc()
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			{
				ClientRpcParams clientRpcParams = default(ClientRpcParams);
				FastBufferWriter bufferWriter = __beginSendClientRpc(3884530962u, clientRpcParams, RpcDelivery.Reliable);
				__endSendClientRpc(ref bufferWriter, 3884530962u, clientRpcParams, RpcDelivery.Reliable);
			}
			if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost))
			{
	...
	{
		blowtorchParticle.gameObject.SetActive(value: false);
		blowtorchParticle.gameObject.SetActive(value: true);
	...
	{
		NetworkManager.__rpc_func_table.Add(3910336672u, __rpc_handler_3910336672);
		NetworkManager.__rpc_func_table.Add(492577947u, __rpc_handler_492577947);
		NetworkManager.__rpc_func_table.Add(2143274786u, __rpc_handler_2143274786);
		NetworkManager.__rpc_func_table.Add(220033949u, __rpc_handler_220033949);
		NetworkManager.__rpc_func_table.Add(773938193u, __rpc_handler_773938193);
		NetworkManager.__rpc_func_table.Add(930524462u, __rpc_handler_930524462);
		NetworkManager.__rpc_func_table.Add(742303271u, __rpc_handler_742303271);
		NetworkManager.__rpc_func_table.Add(355979910u, __rpc_handler_355979910);
		NetworkManager.__rpc_func_table.Add(4127084456u, __rpc_handler_4127084456);
		NetworkManager.__rpc_func_table.Add(2435131453u, __rpc_handler_2435131453);
		NetworkManager.__rpc_func_table.Add(3895603057u, __rpc_handler_3895603057);
		NetworkManager.__rpc_func_table.Add(1452186173u, __rpc_handler_1452186173);
		NetworkManager.__rpc_func_table.Add(3707286996u, __rpc_handler_3707286996);
		NetworkManager.__rpc_func_table.Add(2279077176u, __rpc_handler_2279077176);
		NetworkManager.__rpc_func_table.Add(1073473023u, __rpc_handler_1073473023);
		NetworkManager.__rpc_func_table.Add(3684373613u, __rpc_handler_3684373613);
		NetworkManager.__rpc_func_table.Add(1292035047u, __rpc_handler_1292035047);
		NetworkManager.__rpc_func_table.Add(4188407647u, __rpc_handler_4188407647);
		NetworkManager.__rpc_func_table.Add(3884530962u, __rpc_handler_3884530962);
	}
	...
	private static void __rpc_handler_3910336672(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			((RadMechAI)target).ChangeBroadcastClipClientRpc(value);
	...
	private static void __rpc_handler_492577947(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).ChangeFlightLandingPositionClientRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_2143274786(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		{
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).EndFlightClientRpc();
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_220033949(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetChargingForwardClientRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_773938193(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			reader.ReadValueSafe(out Vector3 value);
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).EnterFlightClientRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_930524462(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		{
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetMechAlertedClientRpc();
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_742303271(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			reader.ReadValueSafe(out bool value, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetAimingClientRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_355979910(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).ShootGunClientRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_4127084456(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			((RadMechAI)target).SetExplosionServerRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_2435131453(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetExplosionClientRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_3895603057(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			reader.ReadValueSafe(out bool value, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetHasLineOfSightClientRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_1452186173(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			reader.ReadValueSafe(out bool value, default(FastBufferWriter.ForPrimitives));
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetLostCreatureInChaseClientRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_3707286996(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			ByteUnpacker.ReadValueBitPacked(reader, out int value);
			target.__rpc_exec_stage = __RpcExecStage.Server;
			((RadMechAI)target).GrabPlayerServerRpc(value);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_2279077176(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).GrabPlayerClientRpc(value, value2, value3);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_1073473023(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		{
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).StartGrabAttemptClientRpc();
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_3684373613(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		{
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).FinishAttemptingGrabClientRpc();
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_1292035047(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		if ((object)networkManager != null && networkManager.IsListening)
		{
			...
			reader.ReadValueSafe(out Vector3 value2);
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).SetTargetToThreatClientRpc(value, value2);
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_4188407647(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		{
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).TakeLeftStepForwardClientRpc();
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
	...
	private static void __rpc_handler_3884530962(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		...
		{
			target.__rpc_exec_stage = __RpcExecStage.Client;
			((RadMechAI)target).TakeRightStepForwardClientRpc();
			target.__rpc_exec_stage = __RpcExecStage.None;
		}
	}
