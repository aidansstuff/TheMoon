...
public class StartOfRound : NetworkBehaviour
{
	...
	public void SetMagnetOnClientRpc(bool on)
	{
		...
		if (__rpc_exec_stage == __RpcExecStage.Client && (networkManager.IsClient || networkManager.IsHost) && magnetOn != on)
		{
			magnetOn = on;
			if (on)
			{
	...
	public void SyncShipUnlockablesClientRpc(int[] playerSuitIDs, bool shipLightsOn, Vector3[] placeableObjectPositions, Vector3[] placeableObjectRotations, int[] placeableObjects, int[] storedItems, int[] scrapValues, int[] itemSaveData, int vehicleID = -1)
	{
		...
		{
			ClientRpcParams clientRpcParams = default(ClientRpcParams);
			FastBufferWriter bufferWriter = __beginSendClientRpc(1450473930u, clientRpcParams, RpcDelivery.Reliable);
			...
			__endSendClientRpc(ref bufferWriter, 1450473930u, clientRpcParams, RpcDelivery.Reliable);
		}
		if (__rpc_exec_stage != __RpcExecStage.Client || (!networkManager.IsClient && !networkManager.IsHost))
		{
			return;
	...
	{
		NetworkManager.__rpc_func_table.Add(3212216718u, __rpc_handler_3212216718);
		NetworkManager.__rpc_func_table.Add(2773812843u, __rpc_handler_2773812843);
		...
		NetworkManager.__rpc_func_table.Add(1450473930u, __rpc_handler_1450473930);
		...
		NetworkManager.__rpc_func_table.Add(2339227601u, __rpc_handler_2339227601);
		NetworkManager.__rpc_func_table.Add(1279156295u, __rpc_handler_1279156295);
	}
	...
	private static void __rpc_handler_1450473930(NetworkBehaviour target, FastBufferReader reader, __RpcParams rpcParams)
	{
		NetworkManager networkManager = target.NetworkManager;
		if ((object)networkManager != null && networkManager.IsListening)
		{
