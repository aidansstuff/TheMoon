...
namespace Dissonance.Networking
{
	internal struct PacketWriter
	{
		...
		public PacketWriter Write(ushort u)
		{
			...
			union.UInt16 = u;
			Union16 union2 = union;
			FastWriteByte(union2.MSB);
			FastWriteByte(union2.LSB);
			return this;
		}
		...
		public PacketWriter Write(uint u)
		{
			...
			union.UInt32 = u;
			Union32 union2 = union;
			union2.GetBytesInNetworkOrder(out var b, out var b2, out var b3, out var b4);
			Write(b);
			Write(b2);
			Write(b3);
			Write(b4);
